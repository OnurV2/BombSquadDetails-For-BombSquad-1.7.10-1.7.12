...
class NewPartyWindow:
                            ...
                            try:
                                if self._roster[index]['players']:
                                    ...
                                    p_str = self._roster[index][
                                        'display_string']
                                p_str = (self._roster[index]['display_string'] if config['Player Type'] == 'Display String' else
                                         str(self._roster[index]['client_id']) if config['Player Type'] == 'Client ID' else p_str)
                            except Exception:
                                ba.print_exception(
    ...
    def switch_players(update_command):
        config['Player Type'] = ('Display String' if config['Player Type'] == 'Normal' else
                                 'Client ID' if config['Player Type'] == 'Display String' else 'Normal')
